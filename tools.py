...
class BotState:
    ...
    command_disabled_users: Set[int] = field(default_factory=set)
    ...
    def to_dict(self, guild: Optional[discord.Guild], active_vc_sessions_to_save: dict, current_time: float) -> dict:
        ...
        return {
            ...
            "command_disabled_users": list(self.command_disabled_users),
    ...
    def from_dict(cls, data: Dict[str, Any], config: BotConfig) -> 'BotState':
        ...
        # Support loading old save files by checking for the old key name as a fallback.
        state.command_disabled_users = set(data.get("command_disabled_users", data.get("omegle_disabled_users", [])))
